...
class LlamaTrainer(Trainer):
    def __init__(
        ...
        super(LlamaTrainer, self).__init__(
            model=model,
            args=args,
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None, **kwargs):
        ...
        raw_ce = outputs_harm["loss"] if isinstance(outputs_harm, dict) else outputs_harm[0]
        print(f'raw_ce_harm={raw_ce.item():.4f}', flush=True)
        ...
        print('loss_harm={}, loss_help={}, loss_algn={}, loss={}'.format(loss_harm.item(), loss_help.item(), loss_algn.item(), loss.item()), flush=True)
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        if hasattr(data_collator, 'signature_columns'):
            data_collator.signature_columns += [
                'input_ids2', 'labels2', 'attention_mask2',
                'input_ids3', 'labels3', 'attention_mask3',
            ]
